<?php
/**
 * ABC de Programa Presupuestario
 *
 * @category ABC
 * @package ap_grp
...
<script type="text/javascript" src="javascripts/ABC_Programa_Presupuestario.js?v=<?= rand();?>"></script>
<!-- tabla de busqueda -->
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <div id="mensajesValidaciones" name="mensajesValidaciones"></div>
            <br>
                <component-text-label label="PP: " id="txtCPPT" name="txtCPPT" placeholder="PP" maxlength="4" onkeypress="return primeroLetra(event, this)"></component-text-label>
              <br>
