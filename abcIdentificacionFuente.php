<?php
/**
 * ABC de Identificaciónes de la fuente
 *
 * @category ABC
 * @package ap_grp
...
<script type="text/javascript" src="javascripts/abcIdentificacionFuente.js"></script>
<!-- tabla de busqueda -->
<div class="row">
  ...
  <div class="modal-dialog modal-lg" role="document" name="ModalGeneralTam" id="ModalGeneralTam">
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <component-number-label label="Clave: " max="9" maxlength="1" id="txtClave" name="txtClave" placeholder="Clave"></component-number-label>
        <br>
