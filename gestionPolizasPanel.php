...
<!-- target="_blank" -->
<a href="gestionPolizas.php" name="Link_NuevoGeneral" id="Link_NuevoGeneral" class="btn btn-primary" style="width: 200px; display: none;"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Link Nuevo</a>
...
<div align="left">
    ...
    <div id="PanelBusqueda" name="PanelBusqueda" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <div class="row clearfix">
          ...
          <div class="col-md-4">
            <component-text-label label="Folio Póliza:" id="txtFolioPoliza" name="txtFolioPoliza" placeholder="Folio Póliza" title="Folio Póliza" value=""></component-text-label>
          </div>
          <div class="col-md-4">
        ...
        <div class="row clearfix">
          <div class="col-md-4">
              <div class="form-inline row">
                ...
                <div class="col-md-9">
                    <select id="selectTipoPoliza" name="selectTipoPoliza[]" class="form-control selectTipoPolizaSeguros" multiple="multiple">
                    </select>
                </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-inline row">
                ...
                <div class="col-md-9">
                    <select id="selectAseguradora" name="selectAseguradora" class="form-control selectAseguradoraSeguros" multiple="multiple">
                    </select>
                </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-inline row">
                ...
                <div class="col-md-9">
                    <select id="selectCobertura" name="selectCobertura" class="form-control selectCoberturaSeguros" multiple="multiple">
                    </select>
                </div>
            </div>
          </div>
  ...
  <div class="panel panel-default">
    <div class="panel-body" align="center" id="divBotones" name="divBotones">
      ...
      <a href="gestionPolizas.php" name="Link_Nuevo" id="Link_Nuevo" class="btn btn-default botonVerde glyphicon glyphicon-plus"> Nuevo</a>
    </div>
  </div>
</div>

<script type="text/javascript" src="javascripts/gestionPolizasPanel.js"></script>
