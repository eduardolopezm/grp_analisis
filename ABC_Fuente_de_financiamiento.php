...
<script type="text/javascript" src="javascripts/ABC_Fuente_de_financiamiento.js"></script>
<!-- tabla de busqueda -->
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <div class="input-group">
          ...
          <select id="selectIdentificador" name="selectIdentificador" class="form-control selectFuenteRecurso" onchange="fnFinalidadFuncion()"></select>
        </div>
        <br>
        <div class="input-group">
          <span class="input-group-addon" style="background: none; border: none;"> Fuente: </span>
          <select id="selectFuente" name="selectFuente" class="form-control"></select>
        </div>
        <br>
        <component-number-label label="Clave: " max="99" maxlength="9" id="txtClave" name="txtClave" placeholder="Clave"></component-number-label>
        <br>
