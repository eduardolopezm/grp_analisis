...
<script type="text/javascript" src="javascripts/ABC_Subfuncion.js"></script>
<!-- tabla de busqueda -->
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <div class="input-group">
          ...
          <select id="selectFinalidad" name="selectFinalidad" class="form-control selectFinalidad" onchange="fnFinalidadFuncion()"></select>
        </div>
        <br>
        <div class="input-group">
          <span class="input-group-addon" style="background: none; border: none;"> FU: </span>
          <select id="selectFuncion" name="selectFuncion" class="form-control"></select>
        </div>
        <br>
        <component-number-label label="SF: " max="99" maxlength="2" id="txtClave" name="txtClave" placeholder="SF"></component-number-label>
        <br>
