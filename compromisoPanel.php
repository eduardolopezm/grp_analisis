 ...
 * @link(target, link)
 * Fecha Creación: 18/07/2018
 * Fecha Modificación: 18/07/2018
 * Vista para el proceso del panel de Compromisos
 */
...
<div align="left">
    ...
    <div id="PanelBusqueda" name="PanelBusqueda" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <div class="col-md-4">
          ...
          <br>
          <component-number-label label="Número Compromiso:" id="txtIdCompromiso" name="txtIdCompromiso" placeholder="Número Compromiso" title="Número Compromiso" value=""></component-number-label>
          <br>
  ...
  <div class="panel panel-default">
    <div class="panel-body" align="center" id="divBotones" name="divBotones">
      ...
      <a id="btnNuevo" name="btnNuevo" href="compromiso.php" class="btn btn-default botonVerde glyphicon glyphicon-plus"> Nuevo</a>
    </div>
  </div>
</div>

<script type="text/javascript" src="javascripts/compromisoPanel.js?<?php echo rand(); ?>"></script>
