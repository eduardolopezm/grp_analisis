...
<script type="text/javascript" src="javascripts/abcTipoIngreso.js"></script>
<!-- tabla de busqueda -->
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <div class="input-group">
          ...
          <select id="selectRubro" name="selectRubro" class="form-control selectRubro"></select>
        </div>
        <br>
        <component-number-label label="Tipo: " max="9" maxlength="1" id="txtClave" name="txtClave" placeholder="Tipo"></component-number-label>
        <br>
        <component-text-label label="Descripción: " max="255" maxlength="255" id="txtDescripcion" name="txtDescripcion" placeholder="Descripción"></component-text-label>
      </div>
  ...
  <div class="modal-dialog modal-lg" role="document" name="ModalGeneralTam" id="ModalGeneralTam">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <component-text type="hidden" label="Finalidad: " id="txtFinalidadEliminar" name="txtFinalidadEliminar" placeholder="Finalidad"></component-text>
