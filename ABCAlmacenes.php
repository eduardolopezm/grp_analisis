...
$tableName = 'sec_loccxusser';
$tableIdColumn = 'loccode';
$tableColumns = array('userid', 'loccode');

// Datos de tabla principal
$mainTableName = 'locations';
$mainTableIdColumn = 'loccode';
$mainTableTextColumn = 'locationname';
...
echo "<div id='container' style='margin:0 auto; width:603px;'>";
	...
	echo "<h3 style='margin:0 auto; padding:.1em; text-align:center; background-color:#f6de9b;'>" . _("Almacenes") . "</h3>";
