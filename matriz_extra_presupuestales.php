...
?>
<script type="text/javascript" src="javascripts/matriz_extra_presupuestales.js"></script>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-inline row">
									...
									<div class="col-md-9">
										<select id="busquedaPP" name="busquedaPP" class="form-control selectProgramaExtraPresupuestario" multiple="multiple">
										</select>
									</div>
								</div>
								<br>
							...
							<div class="col-md-6">
								...
								<component-text-label label="Clave:" id="busquedaClav" name="busquedaClav" placeholder="Clave" title="Clave" value=""></component-text-label>
								<br>
			...
			<div class="modal-body OverdeSelectsenModales" id="forma" name="forma">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-inline row">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label id="textoPrograma">PP: </label></span>
							</div>
							<div class="col-md-9">
								<select id="txtpp" name="txtpp" class="form-control selectProgramaExtraPresupuestario"> 
									<option value="-1">Seleccionar...</option>
								</select>
							</div>
						</div>
					...
					<div class="col-md-4">
						...
						<div class="form-inline row">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label>Origen: </label></span>
							</div>
							<div class="col-md-9">
								<select id="factesquemadoancho" name="factesquemadoancho" class="form-control factesquemadoancho">
									<option value="-1">Seleccionar...</option>
								</select>
							</div>
						</div>
						...
						<!-- CLAVE -->
						<!-- crear el componente -->
						<component-number-label label="Clave:" id="ordendesplegar" name="ordendesplegar" placeholder="Clave" title="Clave" maxlength="3" value=""></component-number-label>
						<br>
					...
					<div class="col-md-4" id="ColumnaDerecha">
						...
						<div class="form-inline row">
							...
							<div class="col-md-9">
								<select id="factesquemadoalto" name="factesquemadoalto" class="form-control factesquemadoalto">
									<option value="-1">Seleccionar...</option>
								</select>
							</div>
						</div>
	...
	<div class="modal-dialog modal-lg" role="document" name="ModalGeneralTam" id="ModalGeneralTam">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<component-text type="hidden" label="Año: " id="txtYearEliminar" name="txtYearEliminar" placeholder="Año"></component-text>
				<component-text type="hidden" label="ID: " id="txtIDEliminar" name="txtIDEliminar" placeholder="ID"></component-text>
