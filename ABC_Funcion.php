...
<script type="text/javascript" src="javascripts/ABC_Funcion.js"></script>
<!-- tabla de busqueda -->
<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <div class="input-group">
          <span class="input-group-addon" style="background: none; border: none;"> FI: </span>
          <select id="selectFinalidad" name="selectFinalidad" class="form-control selectFinalidad"></select>
        </div>
        <br>
        <component-number-label label="FU: " max="9" maxlength="1" id="txtClave" name="txtClave" placeholder="FU"></component-number-label>
        <br>
