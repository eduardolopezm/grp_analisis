 ...
 * @file     abcEstructuraAdministrativa.php
...
?>
<script type="text/javascript" src="javascripts/abcEstructuraAdministrativa.js?v=<?= rand();?>"></script>
<!-- tabla de busqueda -->
<div class="row">
...
<!-- Modal -->
<div class="modal fade ui-draggable" id="modalAdministrativa" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-inline row">
                            ...
                            <div class="col-md-9">
                                <select id="ur" name="ur" class="form-control selectUnidadNegocio" data-todos="true"></select>
                            </div>
                        </div>
                        ...
                        <!-- AUX1 -->
                        <div class="form-inline row">
                            <div class="col-md-3" style="vertical-align: middle;"> <span><label>Auxiliar 1: </label></span> </div>
                            <div class="col-md-9">
                                <select id="aux" name="aux" class="form-control selectAnexoUno" data-todos="true">
                        ...
                        <!-- EF -->
                        <div class="form-inline row">
                            <div class="col-md-3" style="vertical-align: middle;"> <span><label>EF: </label></span> </div>
                            <div class="col-md-9">
                                <select id="ef" name="ef" class="form-control selectEntidadFederativa" data-todos="true">
                                    <option value="0">Selecccione una opción</option>
                                </select>
                            </div>
                        </div>
