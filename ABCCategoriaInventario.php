...
$title = _('ABC Cateroria de Inventarios');
...
$tableName = 'sec_stockcategory';
$tableIdColumn = 'categoryid';
$tableColumns = array('userid', 'categoryid');

// Datos de tabla principal
$mainTableName = 'stockcategory';
$mainTableIdColumn = 'categoryid';
$mainTableTextColumn = 'categorydescription';
...
echo "<div id='container' style='margin:0 auto; width:603px;'>";
	...
	echo "<h3 style='margin:0 auto; padding:.1em; text-align:center; background-color:#f6de9b;'>" . _("Categoria") . "</h3>";
