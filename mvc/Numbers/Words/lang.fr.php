...
// +----------------------------------------------------------------------+
//
// $Id: lang.fr.php,v 1.1 2006/11/17 05:59:52 daintree Exp $
...
class Numbers_Words_fr extends Numbers_Words {
	 ...
	 *        	
	 * @param boolean $last
	 *        	A flag, that determines if it is the last group of digits -
	 ...
	 *
	 * @param integer $num
	 *        	An integer (or its string representation) between 9.99*-10^302
