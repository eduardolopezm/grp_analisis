...
// +----------------------------------------------------------------------+
//
// $Id: lang.en_US.php,v 1.1 2006/11/17 05:59:52 daintree Exp $
//
...
class Numbers_Words_en_US extends Numbers_Words {
	 ...
	 *        	An international currency symbol
	 *        	as defined by the ISO 4217 standard (three characters)
	 * @param integer $decimal
	 *        	A money total amount without fraction part (e.g. amount of dollars)
	 * @param integer $fraction
	 *        	Fractional part of the money amount (e.g. amount of cents)
	 *        	Optional. Defaults to false.
	 * @param integer $convert_fraction
	 *        	Convert fraction to words (left as numeric if set to false).
