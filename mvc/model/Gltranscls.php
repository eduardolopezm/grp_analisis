...
class Gltranscls {
	...
	private $lastdatemod;
	private $dateadded;
	private $exportarcontpaq;
	private $foliocontpaq;
    ...
    public function getSuppno()
    {
        return $this->suppno;
    }

    public function setSuppno($suppno)
    {
        $this->suppno = $suppno;
    ...
    public function getPurchno()
    {
        return $this->purchno;
    }

    public function setPurchno($purchno)
    {
    ...
    public function getPayapplies()
    {
        return $this->payapplies;
    }

    public function setPayapplies($payapplies)
    {
    ...
    public function setTypepaid($typepaid)
    {
    ...
    public function setPercentpaid($percentpaid)
    {
    ...
    public function getCat_cuenta()
    {
        return $this->cat_cuenta;
    }

    public function setCat_cuenta($cat_cuenta)
    {
        $this->cat_cuenta = $cat_cuenta;
    ...
    public function getTypediot()
    {
        return $this->typediot;
    }

    public function setTypediot($typediot)
    {
        $this->typediot = $typediot;

        return $this;
    }

    public function getLastusermod()
    {
        return $this->lastusermod;
    }

    public function setLastusermod($lastusermod)
    {
    ...
    public function getLastdatemod()
    {
        return $this->lastdatemod;
    }

    public function setLastdatemod($lastdatemod)
    {
        $this->lastdatemod = $lastdatemod;
    ...
    public function getExportarcontpaq()
    {
        return $this->exportarcontpaq;
    }

    public function setExportarcontpaq($exportarcontpaq)
    {
        $this->exportarcontpaq = $exportarcontpaq;

        return $this;
    }

    public function getFoliocontpaq()
    {
        return $this->foliocontpaq;
    }

    public function setFoliocontpaq($foliocontpaq)
    {
    ...
    public function getRfcdestino()
    {
        return $this->rfcdestino;
    }

    public function setRfcdestino($rfcdestino)
    {
    ...
    public function getEnter_date()
    {
        return $this->enter_date;
    }

    public function setEnter_date($enter_date)
    {
