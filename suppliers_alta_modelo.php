...
switch ($proceso) {
    ...
    case 'partidas2':
      ...
      while ($myrow = DB_fetch_array($TransResult)){
         ($myrow['ln_activo']=='1') ? $r="Desactivar" : $r="Activar";
...
$dataObj = array('info' =>$SQL, 'contenido' => $contenido, 'result' => $result, 'RootPath' => $RootPath, 'ErrMsg' => $ErrMsg, 'Mensaje' => $Mensaje);
