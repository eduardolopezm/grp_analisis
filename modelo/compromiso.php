...
$SQL = "
SELECT tb_compromiso.nu_estatus, tb_compromiso.nu_tipo, '0' as sn_cancel, tb_botones_statusSig.functionid, '0' as requisitionno
FROM tb_compromiso 
    ...
    <div id="PanelBusqueda" name="PanelBusqueda" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        <div class="col-md-4">
          ...
          <br>
          <component-number-label label="Id Compromiso:" id="txtIdCompromiso" name="txtIdCompromiso" placeholder="Id Compromiso" title="Id Compromiso" value="" disabled="true" onchange="fnCambioIdCompromiso(this.value)"></component-number-label>
        </div>
        <div class="col-md-4">
