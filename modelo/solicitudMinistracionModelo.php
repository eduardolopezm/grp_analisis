...
if ($option == 'obtenerMinistracion'){
    ...
    while ($myrow = DB_fetch_array($result)) {
        ...
        $info[] = array(
            ...
            'num_transferencia' => $myrow ['num_transferencia'],
            'num_oficio' => $myrow ['num_oficio']
...
if ($option == 'autorizarMinistracion'){
    ...
    $Mensaje = fnContabilidadMinistracion($folio,$idMinistracion,$ur,$mes, $num_transferencia, $num_oficio,$db);
    $result = true;
...
function fnContabilidadMinistracion($folio,$idMinistracion,$ur,$mes,$num_transferencia,$num_oficio,$db){
    $msjError="";
    $msjErrorContable="";
    ...
    if($msjError==""){
        ...
        $SQL = "UPDATE tb_ministracion 
                SET estatus = 5, num_transferencia = '".$num_transferencia."', num_oficio = '".$num_oficio."'
