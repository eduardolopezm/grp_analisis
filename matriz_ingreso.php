...
?>
<script type="text/javascript" src="javascripts/matriz_ingreso.js?v=<?= rand();?>"></script>
			...
			<div class="modal-body OverdeSelectsenModales" id="forma" name="forma">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="form-inline row">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label>Capitulo [Radicado]: </label></span>
							</div>
							<div class="col-md-9">
								<select id="selectCapitulo" name="selectCapitulo" class="form-control selectCapitulosMinistracion"> 
									<option value="-1">Seleccionar...</option>
								</select>
							</div>
						</div>
					...
					<div class="col-md-4">
						<component-number-label label="Partida:" id="txtPartidaEspecifica" name="txtPartidaEspecifica" placeholder="Partida" title="Partida Especifica" maxlength="5" value="" onchange="fnTraeInformacionPartidaEspecifica(this.value)"></component-number-label>
						<br>
						<!-- PARTIDA GENÉRICA -->
						<!-- crear el componente -->
