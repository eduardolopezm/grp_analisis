...
<script type="text/javascript" src="javascripts/ABC_Reasignaciones.js"></script>
<!-- tabla de busqueda -->
<div class="row">
  ...
  <div class="modal-dialog modal-lg" role="document" name="ModalGeneralTam" id="ModalGeneralTam">
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        ...
        <component-number-label label="RG: " maxlength="2" max="99" id="txtClave" name="txtClave" placeholder="RG"></component-number-label>
        <br>
