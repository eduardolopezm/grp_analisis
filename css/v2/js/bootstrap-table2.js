...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s Registros por p&aacute;gina', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Mostrando %s de %s registros', pageTo, totalRows);
        },
        formatDetailPagination: function (totalRows) {
            return sprintf('Mostrando %s registros', totalRows);
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '</button>',
                '<ul class="dropdown-menu" style="background-color: #F9F9F9;" role="menu">');
