		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						     ...
						     'ol'		: { "text": "N", 
											...
											"tooltip": "Insertar/Remover Lista Enumerada", 
						     ...
						     'ul'		: { "text": "Bullet", 
											...
											"tooltip": "Insertar/Remover Lista con Viñetas",
						     ...
						     'l_align'	: { "text": "leftalign", 
											...
											//"tooltip": "Align Left", 
											"tooltip": "Alineación al a Izquierda",
						     ...
						     'r_align'	: { "text": "rightalign", 
											...
											//"tooltip": "Align Right",
											"tooltip": "Alineación a la Derecha",  
						...
						'insert_table'	: { "modal": true,
						   ...
						   'outdent'	: { "text": "Outdent", 
							...
							'splchars'	: { "text": "S", 
											...
											"tooltip": "Insertar Caracter Especial ",
											"commandname":null, 
											"custom":function(button){
			...
			var statusBar = $("<div/>", {	id : "statusbar",
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div class="label">'+'Palabras : '+wordCount+'</div>');
					$(editor_Content).data("statusBar").append('<div class="label">'+'Caracteres : '+charCount+'</div>');
            	});
	        }	        
