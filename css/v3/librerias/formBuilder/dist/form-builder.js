...
function formBuilderHelpersFn(opts, formBuilder) {
  ...
  _helpers.xmlSave = function (form) {
    ...
    utils.forEach(formData, function (fieldIndex, field) {
      ...
      //xml.push('\n\t\t' + xmlField.outerHTML);
      xml.push(xmlField.outerHTML);
    });

    //xml.push('\n\t</fields>\n</form-template>');
    xml.push('</fields></form-template>');
  ...
  var FormBuilder = function FormBuilder(options, element) {
    ...
    var defaults = {
      ...
      messages: {
        ...
        allFieldsRemoved: 'Se quitaron todos los campos.',
        ...
        checkboxGroup: 'Grupo de casillas de verificacion',
        checkbox: 'Casilla de verificacion',
        checkboxes: 'Casillas de verificacion',
        className: 'Clase',
        clearAllMessage: 'Estas seguro de querer limpiar todos los campos?',
        clearAll: 'Limpiar',
        close: 'Cerrar',
        content: 'Contenido',
        ...
        devMode: 'Modo de programador',
        editNames: 'Editar Nombres',
        editorTitle: 'Los elementos de formulario',
        editXML: 'Editar XML',
        enableOther: 'Habilitar &quot;Other&quot;',
        enableOtherMsg: 'Permite a los usuarios introducir una opcion de desenlistar',
        fieldDeleteWarning: false,
        fieldVars: 'Variables del campo',
        fieldNonEditable: 'Este campo no puede ser editado.',
        fieldRemoveWarning: 'Estas seguro de que quieres eliminar este campo?',
        ...
        option: 'Opcion',
        optional: 'Opcional',
        optionLabelPlaceholder: 'Etiquete',
        optionValuePlaceholder: 'Valor',
        optionEmpty: 'El valor de la opcion requerida',
        other: 'Otro',
        paragraph: 'Parrafo',
        ...
        placeholders: {
          ...
          placeholder: '',
          className: 'Las clases separadas por espacios',
        ...
        selectionsMessage: 'Permitir la seleccion multiple',
        size: 'Tamaño',
        sizes: {
          xs: 'Extra pequeño',
          sm: 'pequeño',
    ...
    if (opts.showActionButtons) {
      ...
      clearButton.click(function () {
        ...
        if (fields.length) {
          ...
          _helpers.dialog('No hay campos que limpiar', { pageX: coords.pageX, pageY: coords.pageY });
        }
      });
