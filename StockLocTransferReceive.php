...
$title= traeNombreFuncion($funcion, $db,"Transferencias Entrada");

$permisoAlmacenista  = Havepermission($_SESSION ['UserID'], 2454, $db);//2293 permisos almacenista
...
<script src="javascripts/StockLocTransferReceive.js?v=<?= rand();?>"></script>
