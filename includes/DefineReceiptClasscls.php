...
Class Customer_Branch {
	...
	function add_payment($Amount, $glt, $ref, $cur, $leg, $tipocambio, $conversion){
		$this->Items[$this->ItemCounter] = new Payment($Amount, $glt, $ref, $cur, $leg, $this->ItemCounter,$tipocambio,$conversion);
		$this->ItemCounter++;
...
Class Payment {
	...
	function Payment ($Amt, $glt, $ref, $cur, $leg, $id, $tipocambio, $conversion){
...
Class RazonSocial {
	...
	function add_to_docs($id,$type,$typename,$transno,$branchcode,$trandate,$reference,$invtext,$order_,$rate,$tagref, $totalamount,
			 $allocated,$diffonexch,$ovgst,$ovamount, $porpagar,$diasvencimiento,$aplicarmoratorios,$moratorios, $abono,$aplicartodo,$numcuenta,$folio,$uso,$moneda)
	{
		$this->Documentos[$this->DocContador] = new Doctos($id,$type,$typename,$transno,$branchcode,$trandate,$reference,$invtext,$order_,$rate,$tagref, $totalamount,
			 $allocated,$diffonexch,$ovgst,$ovamount, $porpagar,$diasvencimiento,$aplicarmoratorios,$moratorios,$abono,$aplicartodo,$numcuenta,$folio,$uso,$moneda,$this->DocContador);
		$this->DocContador++;
...
Class Doctos {
	...
	function Doctos ($id,$type,$typename,$transno,$branchcode,$trandate,$reference,$invtext,$order_,$rate,$tagref, $totalamount,
			 $allocated,$diffonexch,$ovgst,$ovamount, $porpagar,$diasvencimiento,$aplicarmoratorios,$moratorios, $abono,$aplicartodo,$numcuenta,$folio,$uso,$moneda,$indice){
