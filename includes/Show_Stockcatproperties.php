...
//echo DATE('d/m/Y');
$sql = "SELECT distinct stockcatproperties.Ordenar, stockcatproperties.stkcatpropid,label,controltype,stockcatSelTypes.objectType,stockcatSelTypes.classname,
				defaultvalue,reqatsalesorder,salesstockproperties.valor, stockcatSelTypes.selTableName as queryofvals,
				stockcatproperties.addresslink,stockcatproperties.addressref,stockcatproperties.requiredtoprocess,stockcatproperties.requiredtoday,
				reqatprint	
...
while ($myrowc = DB_fetch_array($result)) {
	...
	// Concateno los valores que previamente habia guardado
		$sql = "SELECT distinct stockcatproperties.stkcatpropid,label,controltype,stockcatSelTypes.objectType,stockcatSelTypes.classname,
								defaultvalue,reqatsalesorder,salesstockproperties.valor, stockcatSelTypes.selTableName as queryofvals,
							reqatprint
					FROM stockcatproperties join stockcatSelTypes on stockcatproperties.controltype = stockcatSelTypes.seltypeid
