...
Class Allocation {
	...
	function add_to_AllocsAllocn ($ID, $TransType, $TypeNo, $TransDate, $SuppRef, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID, $tagref, $currcode,$DifAllocAmt,$tcdiadocto,$aplicacionME,$tagname){
		if ($TransAmount >0){
			$this->Allocs[$ID] = new Allocn($ID, $TransType, $TypeNo, $TransDate, $SuppRef, $AllocAmt, $TransAmount, $ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID, $tagref, $currcode,$DifAllocAmt,$tcdiadocto,$aplicacionME,$tagname);
			Return 1;
		} else {
			Return 0;
		}
...
Class Allocn {
	...
	function Allocn ($ID, $TransType, $TypeNo, $TransDate, $SuppRef, $AllocAmt, $TransAmount, 
			$ExRate, $DiffOnExch, $PrevDiffOnExch, $PrevAlloc, $PrevAllocRecordID, $tagref,$currcode,$DifAllocAmt=0,$tcdiadocto,$aplicacionME=0,$tagname=''){
