...
<script type="text/javascript" src="javascripts/paseCobroTodos.js?v=<?= rand();?>"></script>
		...
		<form id="frmFiltroActivos">
			...
			<div class="row">
				<div class="col-md-4 col-xs-4">
					<component-text-label name="txtPlaca" id="txtPlaca" label="Placa:"></component-text-label>
				</div>
				<div class="col-md-4 col-xs-4">
