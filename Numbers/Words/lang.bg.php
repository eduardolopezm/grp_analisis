...
class Numbers_Words_bg extends Numbers_Words {
	 ...
	 * Note that, there are three genders for them (neuter, masculine and feminine).
	 ...
	 *
	 * @param mixed $num
	 *        	An integer or its string representation
	 ...
	 *
	 * @param integer $num
	 *        	An integer between 1 and 999 inclusive.
	 *        	
	 * @param integer $gender
	 *        	An integer which represents the gender of
	 ...
	 *        	
	 * @param boolean $last
	 *        	A flag that determines if the current digits group
	 *        	is the last one.
	 *        	
	...
	function _showDigitsGroup($num, $gender = 0, $last = false) {
		/*
		 * A storage array for the return string. Positions 1, 3, 5 are intended for digit words and everything else (0, 2, 4) for "and" words. Both of the above types are optional, so the size of the array may vary.
		 */
		$ret = array ();
	 ...
	 *
	 * @param integer $num
	 *        	An integer between 9.99*-10^302 and 9.99*10^302 (999 centillions)
