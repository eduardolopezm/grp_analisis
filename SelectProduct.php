...
<div align="left">
        ...
        <div class="row clearfix">
          <div class="col-md-4">
            <div class="form-inline row">
                ...
                <div class="col-md-9">
                    <select id="selectTipoProducto" name="selectTipoProducto[]" class="form-control selectTipoProducto" multiple="multiple">
                    </select>
                </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-inline row">
                ...
                <div class="col-md-9 hide">
                    <select id="selectPartidaGen" name="selectPartidaGen[]" class="form-control selectPartidaGen" multiple="multiple">
                    </select>
                </div>
                <div class="col-md-9">
                    <select id="selectPartidaEsp" name="selectPartidaEsp[]" class="form-control selectPartidaEsp" multiple="multiple">
                    </select>
                </div>
            </div>
          </div>
          <div class="col-md-4">
            ...
            <component-text-label label="Descripción:" id="txtDescripcion" name="txtDescripcion" placeholder="Descripción" title="Descripción" value=""></component-text-label>
          </div>
        </div>
        <div class="row"></div>
        <div align="center">
  ...
  <div class="panel panel-default">
    <div class="panel-body" align="center" id="divBotones" name="divBotones">
      ...
      <a id="linkNuevo" name="linkNuevo" href="Stocks_V_2.php" class="btn btn-default botonVerde glyphicon glyphicon-plus"> Nuevo</a>
    </div>
  </div>
</div>
<script type="text/javascript" src="javascripts/selectProduct.js?v=<?= rand();?>"></script>
<?php
