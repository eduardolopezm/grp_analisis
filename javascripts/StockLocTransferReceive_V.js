...
var url = "modelo/StockLocTransferReceiveModelo_V.php";
...
$(document).ready(function() {
    ...
    if (document.querySelector(".almacen")) {
		dataObj = { 
          ...
          fnSelectGeneralDatosAjax('.almacen', dataObj, 'modelo/StockLocTransferReceiveModelo_V.php', 0);
    }
...
function fnArticulo(idRequisicion, orden, fEntrega, indiceIncremento, idPartida, idItem, descItem, unidad, cantidad, precio, total, existencia, clavepresupuestal, descLarga, renglon, anexoTec, idItemDetalle){
    var idReq = $("#idtxtRequisicion").val();
    ...
    $(containerArticulo).append('<div class="row p0 m0">'+
            '<ol id=idElementArticulo' + orden + ' class="idElementArticulo col-lg-12 col-md-12 col-sm-12 p0 m0">' +
                ...
                '<li id="idCvePartidaDescArticulo' + orden + '" class="w35p p0"><select id="selectArticulo' + orden + '" name="selectArticulo' + orden + '" class="form-control selectArticulo" onchange="fnDescArticulo('+orden+');"><option value="0">Articulos ...</option></select></li>'+
