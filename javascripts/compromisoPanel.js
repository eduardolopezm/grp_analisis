...
var mensajeEstatusDiferentes = '<p><i class="glyphicon glyphicon-remove-sign text-danger" aria-hidden="true"></i> Selecciono Folio(s) con Estatus diferente, los Estatus deben ser igual</p>';
...
$( document ).ready(function() {
    ...
    if (document.querySelector(".selectEstatusCompromiso")) {
		...
		fnSelectGeneralDatosAjax('.selectEstatusCompromiso', dataObj, 'modelo/compromisoPanelModelo.php', 0);
	}
...
function fnObtenerRegistrosSuficiencia() {
	...
	$.ajax({
	    method: "POST",
	    dataType:"json",
	    url: "modelo/compromisoPanelModelo.php",
	    data:dataObj
	})
	.done(function( data ) {
		//console.log("Bien");
