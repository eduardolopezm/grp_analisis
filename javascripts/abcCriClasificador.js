 ...
 *
 * @author Juan José Ledesma
 * @version 0.1
 */
var url = "modelo/abcCriClasificadorModelo.php";
var proceso = "";
...
function fnAgregarCatalogoModal() {
   ...
   $('#txtClave').val("");
   $('#txtDescripcion').val("");
   var titulo = '<h3><span class="glyphicon glyphicon-info-sign"></span>Clasificador por  Rubro Ingreso</h3>';
...
function fnEliminar(idSubfuncion,descSubfuncion,idFuncion,idFinalidad) {
   ...
   var mensaje = 'Desea eliminar el CRI ' + idSubfuncion + ' - '+descSubfuncion;
