...
$(document).ready(function() {
	...
	$('#guardar').on('click',function(){
			...
			$.post(modelo, params).then(function(res){
				...
				if(res.success){
					...
					$('#objetoPrincipal').val(objetoPrincipal)
   ...
   $('#forma').css('min-height', '0 !important');
...
function inicioPanel() {
	...
	this.rootFu = 0;
	this.url = getUrl();
	this.modelo = this.url+'/modelo/abcAtributosContratoModelo.php';
...
function llenaTabla(data) {
	...
	tblObj = [
		{ name: 'etiqueta', type: 'string'},// 5
		{ name: 'modificar', type: 'string'},// 7
		{ name: 'eliminar', type: 'string'},// 8
		{ name: 'identificador', type: 'string'},// 9
	];
	tblTitulo = [
		{ text: 'Etiqueta', datafield: 'etiqueta', editable: false, width: '70%', cellsalign: 'center', align: 'center' },// 4
		{ text: 'Modificar', datafield: 'modificar', editable: false, width: '15%', cellsalign: 'center', align: 'center' },// 8
		{ text: 'Eliminar', datafield: 'eliminar', editable: false, width: '15%', cellsalign: 'center', align: 'center' },// 8
	];
