...
function inicioPanel() {
	...
	this.rootFu = 0;
	this.url = getUrl();
	this.modelo = this.url+'/modelo/abcObjetosContratoModelo.php';
...
function llenaTabla(data) {
	...
	tblObj = [
		...
		{ name: 'valor', type: 'string'},// 3
		{ name: 'metros', type: 'string'},// 5
	...
	tblTitulo = [
		...
		{ text: 'Valor Unitario', datafield: 'valor', editable: false, width: '29%', cellsalign: 'center', align: 'center' },// 4
		{ text: 'Variable', datafield: 'metros', editable: false, width: '29%', cellsalign: 'center', align: 'center' },// 7
		{ text: 'Modificar', datafield: 'modificar', editable: false, width: '12%', cellsalign: 'center', align: 'center' },// 8
