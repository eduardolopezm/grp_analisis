<?php
            ...
            include '../class/Timbrado.class.php';            
 ...
 */
            if($generaToken)
            {
                    ...
                    $Timbra = new Timbrado();
                    $trsIDN = rand(1, 10000);
                    $Timbra->setStatusTimbre( $rfc, $getToken, $trsIDN, $trsID, $UUID);                    
                    $codigoEstatus = $Timbra->getCodigoEstatus();
                    $descripcionEstatus = $Timbra->getDescripcionEstatus();
