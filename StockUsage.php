...
fecha: 09/12/2009
2.- se arreglo la avariable $funcion*/
$PageSecurity = 2;
...
echo '<br>' . _('Item') . ' :<b> ' . $StockID . ' - ' . $myrow[0] . ' </b>  (' . _('unidad de medida') . ' :<b> ' . $myrow[1] . ')</b><br><br>';
}

echo "<form action='" . $_SERVER['PHP_SELF'] . '?'. SID ."' method=post>";
echo "<div class='w50p p5 m0 fl'><span class='generalSpan fl w50p p10 text-right'>"._('Código') . ":</span><input class='form-control fl mb10 w50p' type=text name='StockID' size=21 maxlength=20 value='$StockID' ></div>";

echo "<div class='w50p p5 m0 fl'><span class='generalSpan fl w25p p10 text-right'>". _('Almacén') . ":</span><select class='w50p form-control fl mb10' name='StockLocation'> ";
...
echo " <input class='botonVerde' type=submit name='ShowUsage' VALUE='" . _('Muestra el uso del stock') . "'>";
echo " <input class='botonVerde' type=submit name='ShowGraphUsage' VALUE='" . _('Muestra un grafico del uso del stock') . "'>";
//echo '<hr>';
