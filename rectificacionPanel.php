 ...
 * Vista para el proceso del panel de Oficios de Rectificación (Compromisos, Directos, Viáticos, Subsidios, etc.)
 */
...
<div align="left">
  ...
  <div class="panel panel-default">
    <div class="panel-body" align="center" id="divBotones" name="divBotones">
      ...
      <a id="btnNuevo" name="btnNuevo" href="rectificacion.php" class="btn btn-default botonVerde glyphicon glyphicon-plus"> Nuevo</a>
    </div>
  </div>
</div>

<script type="text/javascript" src="javascripts/rectificacionPanel.js?<?php echo rand(); ?>"></script>
