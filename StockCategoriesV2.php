...
?>
<script type="text/javascript" src="javascripts/StockCategoriesV2.js?v=<?= rand();?>"></script>
...
<div class="modal fade ui-draggable" id="modalUsoGeneral" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"><!-- <div class="modal fade" id="modalUsoGeneral" name="modalUsoGeneral" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> -->
			...
			<div class="modal-body OverdeSelectsenModales" id="forma" name="forma">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-inline row">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label id="RecepcionCargoLabel">Recepción Cargo: </label></span>
							</div>
							<div class="col-md-9">
								<component-listado-label id="stockact" name="stockact" placeholder="Recepción Cargo"></component-listado-label>
							</div>
						</div>
						<br>
						...
						<div class="form-inline row">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label id="RecepcionAbonoLabel">Recepción Abono: </label></span>
							</div>
							<div class="col-md-9">
								<component-listado-label id="accountegreso" name="accountegreso" placeholder="Recepción Abono"></component-listado-label>
							</div>
						</div>
						<br>
					...
					<div class="col-md-6" id="ColumnaDerecha">
						...
						<div class="form-inline row">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label id="SalidaCargoLabel">Salida Cargo: </label></span>
							</div>
							<div class="col-md-9">
								<component-listado-label id="adjglact" name="adjglact" placeholder="Salida Cargo"></component-listado-label>
							</div>
						</div>
						<br>
						...
						<!-- SALIDA ABONO -->
						<!-- crear el componente -->
						<div class="form-inline row" id="SalidaAbono">
							<div class="col-md-3" style="vertical-align: middle;">
								<span><label>Salida Abono: </label></span>
							</div>
							<div class="col-md-9">
								<component-listado-label id="ln_abono_salida" name="ln_abono_salida" placeholder="Salida Abono"></component-listado-label>
							</div>
						</div>
						<br>
						<div class="form-inline row">
