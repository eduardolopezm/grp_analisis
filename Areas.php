...
$title = _ ( 'Mantenimiento Areas de Venta' );
...
if (isset ( $SelectedArea )) {
	echo '<div class="centre"><a href="' . $_SERVER ['PHP_SELF'] . '?' . SID . '">' . _ ( 'Listado de Áreas Definidas' ) . '</a></div>';
}
...
if (! isset ( $_GET ['delete'] )) {
	...
	if (isset ( $SelectedArea )) {
		...
		echo '<table><tr><td>' . _ ( 'Código' ) . ':</td><td>' . $_POST ['AreaCode'] . '</td></tr>';
	} else {
	...
	echo '<br><div class="centre"><input tabindex="3" type="Submit" name="submit" value=' . _ ( 'Procesar' ) . '></div></form>';
