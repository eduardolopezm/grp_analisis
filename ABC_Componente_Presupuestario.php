<?php
/**
 * ABC de Componente Presupuestario
 *
 * @category ABC
 * @package ap_grp
...
<script type="text/javascript" src="javascripts/ABC_Componente_Presupuestario.js?v=<?= rand();?>"></script>
<!-- tabla de busqueda -->
<div class="row">
  ...
  <div class="modal-dialog modal-lg" role="document" name="ModalGeneralTam" id="ModalGeneralTam">
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalUR_Mensaje" name="ModalUR_Mensaje">
        <!--Mensaje o contenido-->
        <component-text-label label="Auxiliar 3:" id="txtcp" name="txtcp" placeholder="Auxiliar 3" maxlength="10"></component-text-label>
        <br>
        <component-text-label label="Descripción: " id="txtDescripcion" name="txtDescripcion" placeholder="Descripción" maxlength="255" ></component-text-label>
      </div>
