...
$permisoComenzarCompra= Havepermission($_SESSION['UserID'], 2333, $db);
$permisoConsolidar=Havepermission($_SESSION['UserID'],2366, $db);
...
<?php 
  //////////////////////////////////////////////
  // agregado de permiso para sumatoria total //
  //////////////////////////////////////////////
  $sumatoriaTotal = Havepermission($_SESSION['UserID'], 2364, $db);
?>

<script>
  var sumatoriaTotal = "<?= $sumatoriaTotal; ?>";
</script>
    ...
    <div id="PanelRequisiciones" name="PanelRequisiciones" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" data-funcion="<?= $funcion ?>">
      <div class="panel-body">
        <div class="col-md-4">
          ...
          <div class="form-inline row">
              <div class="col-md-3 pt10" style="vertical-align: middle;">
                  <span><label>Código Expediente: </label></span>
              </div>
              <div class="col-md-9 col-lg-9">
                  <component-text label="Código Expediente:" id="codigoExpediente" name="codigoExpediente" placeholder="Código Expediente" title="Código Expediente" value="" maxlength="20" style="width: 100%;"></component-text>
              </div>
          </div>
        </div>
        ...
        <div class="col-md-4 pt20">
          <div class="form-inline row">
              ...
              <div class="col-md-9 col-lg-9">
                  <input class="form-control w100p" type="number" id="txtNumeroRequisicion" name="txtNumeroRequisicion" min="0">
              </div>
          </div>
          ...
          <!-- <div class="row">
            <div  class="col-md-3 p0 m0"><label for="">Folio de Requisici&oacute;n:</label></div>
            <div class="col-md-9 p0 m0">
              <component-number id="txtNumeroRequisicion" name="txtNumeroRequisicion" value=""></component-number>
            </div>
          </div> -->
        ...
        <!--<div class="panel-footer">-->
            <component-button type="submit" id="btnBuscarRequisiciones" name="btnBuscarRequisiciones" class="glyphicon glyphicon-search" onclick="return false;" value="Filtrar"></component-button>
...
<div class="panel panel-default">
    <div class="panel-body" align="center" id="divBotones" name="divBotones">
        ...
        if ($permisoComenzarCompra==1) {
            echo '<component-button type="submit" id="btnProvSugeridos" name="btnProvSugeridos" class="glyphicon glyphicon-copy"
                        onclick="return false;" value="Proceso de Compra"></component-button>';
        }
...
<script type="text/javascript" src="javascripts/PO_SelectOSPurchOrder.js?<?php echo rand(); ?>"></script>
<?php
