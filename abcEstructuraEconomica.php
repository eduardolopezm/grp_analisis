 ...
 * @file     abcEstructuraEconomica.php
...
?>
<script type="text/javascript" src="javascripts/abcEstructuraEconomica.js?v=<?= rand();?>"></script>
<!-- tabla de busqueda -->
<div class="row">
...
<!-- Modal -->
<div class="modal fade ui-draggable" id="modalEconomica" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog">
            ...
            <div class="modal-body" id="forma">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- crear el componente -->
                        <div class="form-inline row">
                            <div class="col-md-3" style="vertical-align: middle;"> <span><label>TG: </label></span> </div>
                            <div class="col-md-9">
                                <select id="tg" name="tg" class="form-control selectTipoGasto" data-todos="true">
                                    <option value="0">Selecccione una opción</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <!-- crear el componente -->
                        <div class="form-inline row">
                            <div class="col-md-3" style="vertical-align: middle;"> <span><label>FF: </label></span> </div>
                            <div class="col-md-9">
                                <select id="ff" name="ff" class="form-control selectFuenteFinanciamiento" data-todos="true">
                                    <option value="0">Selecccione una opción</option>
                                </select>
                            </div>
                        </div>
