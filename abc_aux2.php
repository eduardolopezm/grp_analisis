...
<script type="text/javascript" src="javascripts/abc_aux2.js"></script>
  ...
  <div class="modal-dialog modal-lg" role="document" name="ModalGeneralTam" id="ModalGeneralTam">
    <div class="modal-content">
      ...
      <div class="modal-body" id="ModalCg_Mensaje" name="ModalCg_Mensaje">
        ...
        <component-text-label label="Auxiliar 2: " id="txtCg" name="txtCg" placeholder="Auxiliar 2" maxlength="5"></component-text-label>
        <br>
