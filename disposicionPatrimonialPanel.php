 ...
 * Vista para el proceso del Panel de Disposición Final de Bienes
 */
...
<div align="left">
    ...
    <div id="PanelBusqueda" name="PanelBusqueda" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <div class="col-md-4">
          ...
          <br>
          <component-text-label label="Artículo:" id="txtArticulo" name="txtArticulo" placeholder="Artículo" title="Artículo" value="" class="hide"></component-text-label>
        </div>
        <div class="row"></div>
        <div align="center">
          <br>
  ...
  <div class="panel panel-default">
    <div class="panel-body" align="center" id="divBotones" name="divBotones">
      <a id="btnNuevo" name="btnNuevo" href="disposicionPatrimonial.php" class="btn btn-default botonVerde glyphicon glyphicon-plus"> Nuevo</a>
    </div>
  </div>
</div>

<script type="text/javascript" src="javascripts/disposicionPatrimonialPanel.js?<?php echo rand(); ?>"></script>
