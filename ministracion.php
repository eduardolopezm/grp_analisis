                ...
                <div class="panel-body">
                    <div class="row" id="form-search">
                        ...
                        <div class="col-md-4">
                            ...
                            <component-text-label label="CLC SIAFF:" id="txtCLC" name="txtCLC" placeholder="CLC SIAFF"title="CLC SIAFF"></component-text-label> 
                        ...
                        <div class="col-md-4">
                            ...
                            <component-date-label label="Programación del Pago:" id="dateProgramacionPago" name="dateProgramacionPago" placeholder="Programación del Pago" title="Programación del Pago" value=""></component-date-label>
...
<script src="javascripts/ministracion.js?v=<?= rand(); ?>"></script>
